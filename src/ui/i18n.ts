...
const translations = {
  'zh-CN': {
    ...
    webDavEnabled: '启用 WebDAV 同步',
    webDavAutoSync: '保存后自动同步',
    webDavServerUrl: 'WebDAV 地址',
    webDavUsername: '用户名',
    webDavPassword: '密码 / App Password',
    webDavQuickConfig: '快捷配置',
    webDavSave: '校验保存',
    webDavParseQuickConfig: '解析配置',
    webDavUpload: '上传',
    webDavPull: '拉取',
    webDavLastStatus: '{date}：{message}',
    webDavNeverSynced: '尚未同步',
    webDavSettingsSaved: 'WebDAV 同步设置已保存',
    webDavQuickConfigImported: '快捷配置已导入',
    webDavQuickConfigInvalid: '快捷配置无效',
    webDavValidating: 'WebDAV 配置校验中...',
    webDavSyncWorking: 'WebDAV 同步中...',
    confirmWebDavUpload: '上传会用当前本地规则和设置覆盖远程文件，继续？',
    confirmWebDavPull: '拉取会合并远程规则，并保留本地独有规则，继续？',
    presets: '预设',
    presetEntries: '预设表',
    savePresets: '保存预设',
    presetsSaved: '预设已保存',
  ...
  en: {
    ...
    webDavEnabled: 'Enable WebDAV sync',
    webDavAutoSync: 'Auto-sync after saving',
    webDavServerUrl: 'WebDAV URL',
    webDavUsername: 'Username',
    webDavPassword: 'Password / app password',
    webDavQuickConfig: 'Quick config',
    webDavSave: 'Validate and save',
    webDavParseQuickConfig: 'Parse config',
    webDavUpload: 'Upload',
    webDavPull: 'Pull',
    webDavLastStatus: '{date}: {message}',
    webDavNeverSynced: 'Not synced yet',
    webDavSettingsSaved: 'WebDAV sync settings saved',
    webDavQuickConfigImported: 'Quick config imported',
    webDavQuickConfigInvalid: 'Quick config is invalid',
    webDavValidating: 'Validating WebDAV config...',
    webDavSyncWorking: 'WebDAV sync running...',
    confirmWebDavUpload: 'Upload will overwrite the remote files with current local rules and settings. Continue?',
    confirmWebDavPull: 'Pull will merge remote rules and keep local-only rules. Continue?',
    presets: 'Presets',
    presetEntries: 'Preset table',
  ...
  ja: {
    ...
    webDavEnabled: 'WebDAV 同期を有効化',
    webDavAutoSync: '保存後に自動同期',
    webDavServerUrl: 'WebDAV URL',
    webDavUsername: 'ユーザー名',
    webDavPassword: 'パスワード / App Password',
    webDavQuickConfig: 'クイック設定',
    webDavSave: '検証して保存',
    webDavParseQuickConfig: '設定を解析',
    webDavUpload: 'アップロード',
    webDavPull: '取得',
    webDavLastStatus: '{date}: {message}',
    webDavNeverSynced: 'まだ同期されていません',
    webDavSettingsSaved: 'WebDAV 同期設定を保存しました',
    webDavQuickConfigImported: 'クイック設定をインポートしました',
    webDavQuickConfigInvalid: 'クイック設定が無効です',
    webDavValidating: 'WebDAV 設定を検証中...',
    webDavSyncWorking: 'WebDAV 同期中...',
    confirmWebDavUpload: 'アップロードすると現在のローカルルールと設定でリモートファイルを上書きします。続行しますか？',
    confirmWebDavPull: '取得するとリモートルールをマージし、ローカル専用ルールは保持します。続行しますか？',
    presets: 'プリセット',
    presetEntries: 'プリセット表',
    savePresets: 'プリセットを保存',
    presetsSaved: 'プリセットを保存しました',
    openSettings: '設定を開く',
